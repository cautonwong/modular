...
static void test_construct_api_and_lifecycle(void **state) {
    ...
    assert_int_equal(meter.module.init(&meter.module), EDGE_OK);
    ...
    assert_int_equal(meter.module.deinit(&meter.module), EDGE_OK);
...
static void test_null_private_data_is_rejected(void **state) {
    ...
    assert_int_equal(meter.module.init(&meter.module), EDGE_EINVAL);
    ...
    assert_int_equal(meter.module.deinit(&meter.module), EDGE_EINVAL);
}
