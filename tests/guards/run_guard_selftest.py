...
CASES = [
    ...
    ("check_dependencies.py", "tests/guards/dependencies_good", True),
    ("check_dependencies.py", "tests/guards/dependencies_bad", False),
    ...
    ("check_exemptions.py", "tests/guards/exemptions_good", True),
